...
public class TransmittableThreadLocalPoolTest {
    ...
    public static void main(String[] args) {
        ...
        ExecutorService executorService2 = TtlExecutors.getTtlExecutorService(executorService);
        ...
        for (int i = 1; i <= 10; i++) {
            ...
            new Thread(
                    () -> {
                        ...
                        TransmittableThreadLocalPoolTest.context.set(contextMain);
                        // Submit Tasks
                        for (int j = 1; j <= 10; j++) {
                            ...
                            Runnable task = () -> {
                                ...
                                Context contextChild = TransmittableThreadLocalPoolTest.context.get();
